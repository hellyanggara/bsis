<?php
    ...
    $_SESSION['V1c1T2NHTjNQVDA9_activePage'] = 'menu';
    $_SESSION['V1c1T2NHTjNQVDA9_titlePage'] = 'Menu Aplikasi';
    signInCheck();
?>
<!DOCTYPE html>
<html>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo isset($_GET['trash']) ? 'index.php' : '?trash'?>" class="btn btn-<?php echo isset($_GET['trash']) ? 'dark' : 'light'?> btn-sm float-right">
                                <i class="fas fa-trash"></i> Trash
                            </a>
                        </div>
                        <div class="card-body">
                            <div id="cardBodyMenu"></div>
                        </div>
                    </div>
                </div>
            </section>
