<?php
    ...
    $table = "bsis_group_menu_aplikasi";
    $where = "AND `group` = '1'";
    $qGroup = $q->get_list($table,false,false,false,false,false,false,$where)
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <form id="tambahMenu" method="post" enctype="multipart/form-data">  
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">    
                                        ...
                                        <div class="form-group">
                                            <label>Slug</label>
                                            <input name="slug" id="slug" type="text" class="form-control form-control-sm wajib" placeholder="Masukkan Slug">
                                            <span id="spanSlug" class="error invalid-feedback">Slug harus diisi dan mengandung "_"</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Table</label>
                                            <input name="table" id="table" type="text" class="form-control form-control-sm" placeholder="Masukkan Table">
                                            <span class="error invalid-feedback">Table harus diisi</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Icon</label>
                                            <input name="icon" id="icon" type="text" class="form-control form-control-sm wajib" placeholder="Masukkan Icon">
                                            <span class="error invalid-feedback">Icon harus diisi</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Active Menu</label>
                                            <input name="active_menu" id="active_menu" type="text" class="form-control form-control-sm wajib" placeholder="Masukkan Active">
                                            <span class="error invalid-feedback">Active harus diisi</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Direktori</label>
                                            <input name="direktori" id="direktori" type="text" class="form-control form-control-sm wajib" placeholder="Masukkan Direktori">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_group" id="id_group" class="form-control select2 wajib">
                                                ...
                                                echo '<option value="'.$dtGroup->id.'">'.$dtGroup->nama.'</option>';
                                                }
                                                ?>
                                            </select>
