<?php
    ...
    $_SESSION['V1c1T2NHTjNQVDA9_activePage'] = 'mappingUser';
    $_SESSION['V1c1T2NHTjNQVDA9_titlePage'] = 'User';
    signInCheck();
    $slug = $_GET['ref'];
