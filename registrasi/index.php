...
$_SESSION['V1c1T2NHTjNQVDA9_activePage'] = 'registrasi';
$_SESSION['V1c1T2NHTjNQVDA9_titlePage'] = 'Daftar Registrasi';
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php
                                ...
                                echo $sts != '' ? '<span class="badge badge-info mr-1">'.$stsF.'</span>' : '';
                            ?>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Status</label>
                                    <select class="form-control select2" name="sts" id="sts">
                                        <option></option>
                                        <option value="0" <?= $sts == '0' ? 'selected' : '' ?>>Pending</option>
                                        <option value="1" <?= $sts == '1' ? 'selected' : '' ?>>Disetujui</option>
                                        <option value="2" <?= $sts == '2' ? 'selected' : '' ?>>Ditolak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= $httpHost ?>registrasi/" class="btn btn-default float-right">Clear Filter</a>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $("#awal_aktif").on("change.datetimepicker", function (e) {
            $('#akhir_aktif').datetimepicker('minDate', e.date);
        });
        $("#akhir_aktif").on("change.datetimepicker", function (e) {
            $('#awal_aktif').datetimepicker('maxDate', e.date);
        });
